...
const checkDeleteAccountValidity = (id: string, req: Request) => {
  const emptyArgs = emptyArgsExist({ id }, req);
...
export { checkDeleteAccountValidity, checkForgotPasswordValidity, checkRegisterValidity };
